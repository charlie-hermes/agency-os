...
- director-controlled monotonic audit-retention policy, protected signed intent
  ...
  authority-export denial until reconciliation completes, post-reconciliation
  empty-target recovery, content-free tenant-scoped telemetry, exact-manifest
  expiration, stale/forged/too-early denial, immutable receipts,
  restart/recovery continuity and offboarding behavior;
